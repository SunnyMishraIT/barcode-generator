              ...
              {displayMode === 'grid' ? (
                <div className="barcode-grid">
                  {barcodeData.map((barcode) => (
                    ...
                    >
                      {barcode.label && (
                        <Typography variant="body2" sx={{ mb: 1.5, fontWeight: 600, textAlign: 'center', fontSize: '0.65rem' }}>
                          {barcode.label}
                        </Typography>
                      )}
            ...
            {currentPrintBarcode && (
              <Box sx={{ my: 3, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                {currentPrintBarcode.label && (
                  <Typography variant="body2" sx={{ mb: 1.5, fontWeight: 600, fontSize: '0.65rem' }}>
                    {currentPrintBarcode.label}
                  </Typography>
                )}
...
export default BarcodeGeneratorv3; 